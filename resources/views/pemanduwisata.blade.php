...
<div class="pembungkus1">
    <p class="pemandu text-center">Pemandu <span style="color: #F3B27C;">Wisata</span></p>
    <div class="mt-3 flex justify-center">
        <p class="deskripsipemandu text-center text-white">Lorem ipsum dolor sit amet consectetur. Laoreet in nullam in duis ante sed. Lorem ipsum dolor sit amet consectetur amet consectetur.</p>
    </div>
    <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6 my-5">
        <div class="text-white">
            <img src="{{ asset('images/pemandu.jpg') }}" alt="biro">
            <div class="pembungkus2 flex">
                <div>
                    <p class="judul mt-3">Nama Jasa</p>
